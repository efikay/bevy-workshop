...
fn spawn_pause_menu(mut commands: Commands) {
    commands.spawn((
        ...
        children![
            ...
            widget::button("Exit game", quit_to_title), // TODO: Actually quit to title :D
        ],
    ));
}
...
fn quit_to_title(_: Trigger<Pointer<Click>>, mut _next_screen: ResMut<NextState<ScreenState>>) {
    panic!("***** There is mo main menu for now so we're quitting... .-. *****");
    // _next_screen.set(ScreenState::Title);
}
